        ...
        <div class="modal-body">
            <form id="crudCreateForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nid_no" name="nid_no" placeholder="Enter NID No." required>
                </div>
                <div class="mb-3">
                    <label for="passport_no" class="form-label">Passport No.</label>
                    <input type="text" class="form-control" id="passport_no" name="passport_no" placeholder="Enter Passport No." required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="passport_info_upload" name="passport_info_upload" accept="image/*,application/pdf" required>
                </div>
                <div class="mb-3">
                    <label for="pcc_number" class="form-label">PCC Number</label>
                    <input type="text" class="form-control" id="pcc_number" name="pcc_number" placeholder="Enter PCC Number" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="pcc_upload" name="pcc_upload" accept="image/*,application/pdf" required>
                </div>
                <div class="mb-3">
                    <label for="designated_country_name" class="form-label">Designated Country Name</label>
                    <input type="text" class="form-control" id="designated_country_name" name="designated_country_name" placeholder="Enter Designated Country Name" required>
                </div>
                <div class="mb-3">
                    <label for="work_type" class="form-label">Work Type</label>
                    <input type="text" class="form-control" id="work_type" name="work_type" placeholder="Enter Work Type" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="required_doc_name" name="required_doc_name" placeholder="Enter Remarks" rows="3" required></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="contact_amount" name="contact_amount" placeholder="Enter Contact Amount" required>
                </div>
                <div class="mb-3">
                    <label for="deposit_amount" class="form-label">Deposit Amount</label>
                    <input type="number" class="form-control" id="deposit_amount" name="deposit_amount" placeholder="Enter Deposit Amount" required>
                </div>
                <div class="mb-3">
                    <label for="due_amount" class="form-label">Due Amount</label>
                    <input type="number" class="form-control" id="due_amount" name="due_amount" placeholder="Enter Due Amount" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="image_upload" name="image_upload" accept="image/*" onchange="previewImages(event)" data-preview-container="#image_preview" multiple>
                </div>
                <div id="image_preview" class="d-flex flex-wrap mt-2"></div>
                <div class="mb-3">
                    <label for="pdf_upload" class="form-label">PDF Upload</label>
                    <input type="file" class="form-control" id="pdf_upload" name="pdf_upload" accept="application/pdf">
                </div>
                <div class="mb-3">
                    <label for="payment_doc_upload" class="form-label">Payment Doc Upload</label>
                    <input type="file" class="form-control" id="payment_doc_upload" name="payment_doc_upload" accept="application/pdf">
                </div>
                <div class="mb-3">
